...
import { fetchGoogleSignInVisible } from '@/app/models/settings';
...
export default function AdminLogin() {
  ...
  useEffect(() => {
    const checkVisibility = async () => {
      const visible = await fetchGoogleSignInVisible();
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      {isVisible  ? (
        ...
        <Alert
          ...
          description="The Google Sign-In feature is currently being developed. Please check back later."
          type="info"
          showIcon
        />
      )}
